...
- **Type**: `text-xs`, `text-sm`, `text-base`, `text-lg`, `text-3xl`, `font-normal`, `font-medium`, `font-semibold`, `font-bold`, `font-mono`, `leading-none`. System font stack — no webfonts to load.
