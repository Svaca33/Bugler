...
export const alerting: AlertingMessages = {
  ...
  journal: {
    ...
    youArchived: "Epizodu jste archivovali",
    archived: name => `${subj(name)} epizodu archivoval`,
    youUnarchived: "Epizodu jste vrátili z archivu",
    unarchived: name => `${subj(name)} epizodu vrátil z archivu`,
  ...
  actions: {
    ...
    archiveFailed: "Epizodu se nepodařilo archivovat.",
    unarchiveFailed: "Epizodu se nepodařilo vrátit z archivu.",
  },
