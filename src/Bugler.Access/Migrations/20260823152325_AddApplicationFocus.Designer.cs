...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bugler.Access.Users.ApplicationFocus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_application_focuses");

                    b.HasIndex("UserId", "ApplicationId")
                        .IsUnique()
                        .HasDatabaseName("ix_application_focuses_user_id_application_id");

                    b.ToTable("application_focuses", "access");
                });
            ...
            modelBuilder.Entity("Bugler.Access.Users.ApplicationFocus", b =>
                {
                    b.HasOne("Bugler.Access.Users.User", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_application_focuses_users_user_id");
                });
