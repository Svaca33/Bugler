...
namespace Bugler.Access.Outbox;

/// <summary>
/// Access's own outbox: it records what Access owes the other contexts and hands those
...
/// </summary>
internal sealed class AccessOutbox(AccessDbContext dbContext)
