...
namespace Bugler.Alerting.Migrations
{
    ...
    [Migration("20260905095000_KindOfTroubleIsToldByItsWatch")]
    partial class KindOfTroubleIsToldByItsWatch
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bugler.Alerting.Episodes.Episode", b =>
                {
                    ...
                    b.HasIndex(new[] { "ScopeKey", "Watch", "Fingerprint" }, "kind_history")
            ...
            modelBuilder.Entity("Bugler.Alerting.Settings.FingerprintQuietWindow", b =>
                {
                    ...
                    b.HasKey("ScopeKey", "Watch", "Fingerprint")
